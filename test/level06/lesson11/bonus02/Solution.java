...
public class Solution
{
    ...
    public static class Cat
    {
        ...
        {
            if (mother.equals("no mother") && father.equals("no father"))
                return "Cat name is " + name + ", " + mother + ", " + father;
            else if (mother.equals("no mother"))
                return "Cat name is " + name + ", " + mother + ", father is " + father;
            else if (father.equals("no father"))
                return "Cat name is " + name + ", mother is " + mother + ", " + father;
            else
